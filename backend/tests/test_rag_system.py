...
class TestRAGSystemContentQueries:
    ...
    def test_content_query_workflow(self, mock_session_mgr, mock_doc_proc,
                                   mock_vector_store, mock_ai_gen, mock_config):
        """Test end-to-end content query processing"""
        # Setup mocks
        mock_ai_instance = Mock()
        mock_ai_instance.generate_response.return_value = "Variables in Python store data values."
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_session_management_in_queries(self, mock_session_mgr, mock_doc_proc,
                                          mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_session_instance = Mock()
        mock_session_instance.get_conversation_history.return_value = "Previous: context"
        mock_session_mgr.return_value = mock_session_instance
        ...
        response, sources, metadata = rag_system.query("Follow-up question", session_id="test_session")
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_tool_definitions_passed_to_ai(self, mock_session_mgr, mock_doc_proc,
                                          mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_source_reset_after_query(self, mock_session_mgr, mock_doc_proc,
                                     mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_without_session(self, mock_session_mgr, mock_doc_proc,
                                  mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_prompt_formatting(self, mock_session_mgr, mock_doc_proc,
                              mock_vector_store, mock_ai_gen, mock_config):
